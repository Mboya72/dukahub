...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        top: false,
        bottom: true, // FIXED HERE: Bounds scrolling list neatly above bottom navigation layers
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            // FIXED HERE: Replaced with safe backwards-compatible alpha handling
                            color: AppTheme.primaryDark.withAlpha((0.1 * 255).toInt()),
                            blurRadius: 20,
